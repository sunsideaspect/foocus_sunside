...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sunsideaspect/foocus_new/blob/cursor/git-eaf0/fooocus_colab.ipynb) | This fork (direct-prompt preset by default)
...
The full fork notebook starts with `--preset realistic_direct_prompt`.
