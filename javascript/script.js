...
const SUNSIDE_STYLE_TIPS = {
    ...
    "Sunside Hidden Camera": "CCTV з кута стелі — вона в кімнаті, спиною/боком",
    ...
    "Sunside Through Doorway": "камера в коридорі → вона в кімнаті за дверима, не дивиться",
    ...
    "Sunside Shower Peek": "щілина дверей з коридору в душ, unaware",
